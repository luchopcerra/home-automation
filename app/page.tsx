    ...
    <main id="contenido">
      <section className="hero container" aria-labelledby="hero-title">
        <div className="hero-copy"><p className="eyebrow"><span className="status-dot" /> TECNOLOGÍA QUE TE SIMPLIFICA EL DÍA</p>
          ...
          <p className="hero-subcopy">Asesoría en domótica y configuración de Home Assistant para casas y negocios en Los Reartes, Villa General Belgrano y alrededores. También podemos evaluar tu proyecto a distancia.</p>
      ...
      <section className="section container" id="servicios" aria-labelledby="services-title">
        <div className="section-heading"><div><p className="eyebrow">QUÉ PODEMOS HACER</p><h2 id="services-title">Servicios de domótica, paso a paso.</h2></div><p className="section-intro">No hace falta automatizar todo de una vez. Podemos empezar por lo que más te sirva.</p></div>
      ...
      <section className="section container faq-section" id="preguntas-frecuentes" aria-labelledby="faq-title"><div><p className="eyebrow">ANTES DE EMPEZAR</p><h2 id="faq-title">Quizás te estés<br />preguntando…</h2><p className="section-intro">Algunas respuestas para dar<br className="desktop-break" /> el primer paso.</p></div><FAQ /></section>
